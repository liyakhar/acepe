 ...
 */
export type AcpCommands = { initialize: string; new_session: string; resume_session: string; fork_session: string; set_model: string; set_mode: string; send_prompt: string; cancel: string; list_agents: string; install_agent: string; uninstall_agent: string; get_capabilities: string }
