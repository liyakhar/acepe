...
let { mode, refId, anchorRect, textContent, onSave, onClose, onMouseEnter }: Props = $props();
...
>
	...
	<!-- Footer: only shown when text has been modified -->
	{#if isDirty}
