	...
	relatedLinks: [
		{
			...
			description: 'Compare agent review visibility and workflow control against a general coding IDE.',
		},
		{
			href: '/pricing',
			title: 'See pricing',
	...
	relatedLinks: [
		{
			...
			description: 'Compare checkpoint history and operator controls against a minimal coding-agent GUI.',
		},
		{
			href: '/download',
			title: 'Download Acepe',
	...
	relatedLinks: [
		{
			...
			description: 'Compare session triage and operator workflow depth against an open-source agent client.',
		},
		{
			href: '/pricing',
			title: 'See pricing',
