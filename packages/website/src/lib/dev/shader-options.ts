...
import type {
	...
	ShaderPalette,
	ShaderParamValues,
} from "./shader-preference-store.js";
...
const staticMeshGradient: ShaderDefinition = {
	...
	scale: 1.1,
	params: [
		{ kind: "number", id: "positions", label: "Positions seed", default: 12, min: 0, max: 100, step: 1 },
		{ kind: "number", id: "waveX", label: "Wave X", default: 0.4, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "waveXShift", label: "Wave X shift", default: 0.2, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "waveY", label: "Wave Y", default: 0.4, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "waveYShift", label: "Wave Y shift", default: 0.5, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "mixing", label: "Mixing", default: 0.5, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "grainMixer", label: "Grain mix", default: 0.3, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "grainOverlay", label: "Grain overlay", default: 0.15, min: 0, max: 1, step: 0.01 },
	],
	build: ({ palette, values, width, height }) => {
		...
		return { fragment: staticMeshGradientFragmentShader, uniforms: u, webgl: OPAQUE_WEBGL, speed: 0 };
	},
};
...
const meshGradient: ShaderDefinition = {
	...
	scale: 1.15,
	params: [
		{ kind: "number", id: "distortion", label: "Distortion", default: 0.75, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "swirl", label: "Swirl", default: 0.55, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "grainMixer", label: "Grain mix", default: 0.3, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "grainOverlay", label: "Grain overlay", default: 0.18, min: 0, max: 1, step: 0.01 },
	],
	build: ({ palette, values, width, height }) => {
		const u: ShaderMountUniforms = {
			u_colors: colorsVec(palette, 4),
...
const warp: ShaderDefinition = {
	...
	scale: 1.1,
	params: [
		{ kind: "enum", id: "shape", label: "Pattern", default: WarpPatterns.edge, options: WARP_SHAPE_ENUM },
		{ kind: "number", id: "proportion", label: "Proportion", default: 0.5, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "softness", label: "Softness", default: 0.85, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "shapeScale", label: "Shape scale", default: 0.35, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "distortion", label: "Distortion", default: 0.6, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "swirl", label: "Swirl", default: 0.7, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "swirlIterations", label: "Swirl iters", default: 8, min: 0, max: 20, step: 1 },
	],
	build: ({ palette, values, width, height, noise }) => {
		const u: ShaderMountUniforms = {
			u_colors: colorsVec(palette, 4),
...
const waves: ShaderDefinition = {
	...
	params: [
		...
		{ kind: "number", id: "frequency", label: "Frequency", default: 0.6, min: 0, max: 2, step: 0.01 },
		{ kind: "number", id: "amplitude", label: "Amplitude", default: 0.45, min: 0, max: 1, step: 0.01 },
...
const neuroNoise: ShaderDefinition = {
	...
	scale: 1.0,
	params: [
		{ kind: "number", id: "brightness", label: "Brightness", default: 1.1, min: 0, max: 2, step: 0.01 },
		{ kind: "number", id: "contrast", label: "Contrast", default: 0.75, min: 0, max: 2, step: 0.01 },
	],
	build: ({ palette, values, width, height }) => {
...
const perlinNoise: ShaderDefinition = {
	...
	params: [
		...
		{ kind: "number", id: "persistence", label: "Persistence", default: 0.55, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "lacunarity", label: "Lacunarity", default: 2.2, min: 0, max: 4, step: 0.05 },
	],
	build: ({ palette, values, width, height }) => {
		const colors = colorsVec(palette, 1);
		const u: ShaderMountUniforms = {
...
const smokeRing: ShaderDefinition = {
	...
	scale: 1.0,
	params: [
		{ kind: "number", id: "noiseScale", label: "Noise scale", default: 1.2, min: 0, max: 3, step: 0.01 },
		{ kind: "number", id: "thickness", label: "Thickness", default: 0.35, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "radius", label: "Radius", default: 0.55, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "innerShape", label: "Inner shape", default: 1, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "noiseIterations", label: "Iterations", default: 4, min: 1, max: 8, step: 1 },
	],
	build: ({ palette, values, width, height, noise }) => {
		const u: ShaderMountUniforms = {
			u_colorBack: getShaderColorFromString(palette.background),
...
const spiral: ShaderDefinition = {
	...
	params: [
		...
		{ kind: "number", id: "distortion", label: "Distortion", default: 0.35, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "strokeWidth", label: "Stroke width", default: 0.5, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "strokeTaper", label: "Stroke taper", default: 0.4, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "strokeCap", label: "Stroke cap", default: 0.3, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "noise", label: "Noise", default: 0.35, min: 0, max: 1, step: 0.01 },
		{ kind: "number", id: "noiseFrequency", label: "Noise freq", default: 2.2, min: 0, max: 5, step: 0.05 },
		{ kind: "number", id: "softness", label: "Softness", default: 0.85, min: 0, max: 1, step: 0.01 },
	],
	build: ({ palette, values, width, height }) => {
		const colors = colorsVec(palette, 1);
