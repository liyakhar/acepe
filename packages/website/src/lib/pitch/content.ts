...
export const pitchBeatSectionIds = {
	...
	'why-acepe-wins': ['title', 'problem', 'before-after', 'solution', 'traction', 'competition', 'ask'],
...
export const pitchSections = createPitchSections([
	{
		...
		body: [
			'Multi-agent development is here.',
			'Acepe is the control plane above it.',
		],
	...
	},
	{
		...
		body: [
			'Blocked sessions go unseen.',
			'Conflicting edits surface too late.',
		],
	...
	},
	{
		...
		body: [
			'Attention queue + checkpoints.',
			'ACP keeps providers replaceable.',
		],
		thesisBeats: ['platform-neutral', 'why-acepe-wins'],
	},
	{
		...
		summary: 'Proof first: waitlist pull, open-source interest, and inbound users from founder-led distribution.',
		body: [
			'Users already arrive from X.',
	...
	},
	{
		...
		body: [
			'30M+ developers are adopting agents.',
			'The workflow is fragmenting now.',
		],
	...
	},
	{
		...
		body: [
			'Self-serve adoption pulls in developers.',
			'Team workflows create land-and-expand.',
		],
	...
	},
	{
		...
		summary: 'Back the founder, ship team workflows faster, and make Acepe the default operating layer.',
		body: [
