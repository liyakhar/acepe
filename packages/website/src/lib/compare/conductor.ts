...
export const conductorComparison: ComparisonData = {
	...
	features: [
		...
		},
		{
			...
			acepe: 'Dedicated attention queue for questions, permissions, and completions across sessions',
			competitor: 'Homepage says you can see what needs attention at a glance, and the public changelog highlights next-workspace and status-driven flows',
		},
		{
			category: 'Workflow',
			feature: 'Plan mode',
			acepe: 'Structured plans with readable markdown preview before execution',
			competitor: 'Public changelog highlights plan mode, approve-with-feedback flows, and one-click sharing of approved plans',
		},
		{
			category: 'Safety',
			feature: 'Checkpoint recovery',
			acepe: 'Automatic snapshots after each tool run with per-file or per-session revert',
			competitor: 'Public changelog highlights checkpoints and resetting Codex sessions to a previous turn',
		},
		{
			category: 'Safety',
	...
	faqs: [
		...
		},
		{
			...
			answer:
				'Yes. Conductor\'s public homepage FAQ says each workspace is a new git worktree.',
		},
		{
		...
		},
		{
			...
			answer:
				'Yes. Acepe includes SQL Studio with a schema browser and query editor.',
		},
	],
