	...
	const projectPanels = $derived<DemoProjectPanel[]>([
		{
			...
			scene: createScene({
				...
				projectColor: "#9858FF",
				sequenceId: 12,
				userText: "Tighten the review queue so the shared agent panel stops drifting between desktop and website.",
		...
		},
		{
			...
			scene: createScene({
				...
				projectColor: "#9858FF",
				sequenceId: 9,
				userText: "Tighten the launch notes so the new queue and kanban demos feel consistent with the rest of the homepage.",
		...
		},
		{
			...
			scene: createScene({
				...
				projectColor: "#9858FF",
				sequenceId: 6,
				userText: "The homepage hero feels too tight around the demo stage. Ease the spacing without making the fold too tall.",
		...
		},
		{
			...
			scene: createScene({
				...
				projectColor: "#4AD0FF",
				sequenceId: 4,
				userText: "Track the panel parity regressions between website demos and the desktop app before the next release.",
		...
		},
		{
			...
			scene: createScene({
				...
				projectColor: "#4AD0FF",
				sequenceId: 3,
				userText: "Figure out why the temporary worktree cleanup sometimes fails when a session exits early.",
				...
				editFilePath: "packages/desktop/src/lib/acp/components/worktree/worktree-default-store.svelte.ts",
				assistantMarkdown:
		...
		},
		{
			...
			scene: createScene({
				...
				projectColor: "#4AD0FF",
				sequenceId: 8,
				userText: "Tighten the kanban board so the cards read faster at a glance and the column rhythm feels lighter.",
		...
		},
		{
			...
			scene: createScene({
				...
				projectColor: "#FF8D20",
				sequenceId: 2,
				userText: "The new auth layer still mixes session cookies and JWT checks. Simplify it so the middleware has one path.",
		...
		},
		{
			...
			scene: createScene({
				...
				projectColor: "#FF8D20",
				sequenceId: 1,
				userText: "Apply the new token bucket config to the public endpoints and expose the hit counts in monitoring.",
