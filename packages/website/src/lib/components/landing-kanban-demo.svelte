	...
	return [
		{
			...
			items: [
				...
				createCard({
					id: "landing-question-card-2",
					title: "Approve agent panel icon pass",
					...
					diffInsertions: 3,
					diffDeletions: 1,
					todoProgress: { current: 2, total: 4, label: "Decide" },
					sequenceId: 8,
					menuActions: reviewMenuActions,
					footer: {
						kind: "question",
						currentQuestion: {
							question: "Ship the updated top-right chat icons to the landing demo?",
							multiSelect: false,
							options: [{ label: "Ship now" }, { label: "Tweak spacing" }, { label: "Hide for now" }],
						},
						totalQuestions: 1,
						hasMultipleQuestions: false,
						currentQuestionIndex: 0,
						questionId: "landing-icon-question",
						questionProgress: [{ questionIndex: 0, answered: true }],
						currentQuestionAnswered: true,
						currentQuestionOptions: [
							{ label: "Ship now", selected: true, color: "#22C55E" },
							{ label: "Tweak spacing", selected: false, color: "#9858FF" },
							{ label: "Hide for now", selected: false, color: "#FF8D20" },
						],
						otherText: "",
						otherPlaceholder: "Type custom answer...",
						showOtherInput: true,
		...
		},
		{
			...
			items: [
				...
				createCard({
					id: "landing-plan-card-3",
					title: "Plan kanban density refresh",
					agentIconSrc: codexIcon,
					agentLabel: "Codex",
					projectName: "acepe.dev",
					projectColor: "#4AD0FF",
					modeId: "plan",
					activityText: "Sorting additional showcase agents by column…",
					isStreaming: true,
					diffInsertions: 5,
					diffDeletions: 1,
					sequenceId: 14,
					footer: {
						kind: "plan_approval",
						prompt: "Add five more cards while keeping the board balanced?",
						approveLabel: "Approve",
						rejectLabel: "Revise",
					},
				}),
		...
		},
		{
			...
			items: [
				...
				createCard({
					id: "landing-working-card-2",
					title: "Tighten single-view header spacing",
					agentIconSrc: cursorIcon,
					agentLabel: "Cursor",
					projectName: "desktop",
					projectColor: "#18D6C3",
					activityText: "Comparing title row against desktop capture…",
					isStreaming: true,
					diffInsertions: 17,
					diffDeletions: 6,
					todoProgress: { current: 1, total: 4, label: "Polish" },
					taskCard: createTaskCard(
						"Align the header controls and title spacing with the shared panel shell",
						createTool(
							"task-tool-header",
							"Editing",
							"running",
				...
				createCard({
					id: "landing-working-card-3",
					title: "Wire project footer chrome",
					agentIconSrc: claudeIcon,
					agentLabel: "Claude Code",
					projectName: "desktop",
					projectColor: "#9858FF",
					activityText: "Comparing footer controls against desktop shell…",
					isStreaming: true,
					diffInsertions: 14,
					diffDeletions: 3,
					todoProgress: { current: 3, total: 6, label: "Implement" },
					taskCard: createTaskCard(
						"Mirror the lower-left sidebar actions in the website showcase",
						createTool(
							"task-tool-footer",
							"Editing",
							"running",
		...
		},
		{
			...
			items: [
				...
				createCard({
					id: "landing-review-card-3",
					title: "Single panel scene parity",
					agentIconSrc: cursorIcon,
					agentLabel: "Cursor",
					projectName: "website",
					projectColor: "#18D6C3",
		...
		},
		{
			...
			items: [
				...
				createCard({
					id: "landing-idle-card-3",
					title: "Header control parity pass",
					agentIconSrc: claudeIcon,
					agentLabel: "Claude Code",
					projectName: "acepe.dev",
					projectColor: "#9858FF",
					diffInsertions: 10,
					diffDeletions: 2,
					todoProgress: { current: 2, total: 2, label: "Complete" },
					latestTool: createTool(
						"idle-tool-3",
						"Merged",
						"done",
						"packages/ui/src/components/agent-panel-scene/agent-panel-scene-header.svelte"
					),
					sequenceId: 36,
				}),
			],
